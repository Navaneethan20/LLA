...
const stories = [
  ...
  { name: "Pavithra Murugan", achievement: "Founded AgriTech Startup — Raised ₹30L Seed", quote: "The entrepreneurship workshop sparked something in me. I launched my startup solving real problems. LLA gave me the blueprint.", image: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=600&q=80", avatar: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=100&q=80" },
    ...
    <div className="min-h-screen bg-[#0B1832]">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 blur-sm">
          <img src="https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=1400&q=80" alt="College Programs" className="w-full h-full object-cover" />
...
/>;
      ...
      <SubContact />
      <Footer />
      <WhatsAppPopup programName="College Programs" groupLink="https://chat.whatsapp.com/livingleadership-college" />
    </div>
  );
}